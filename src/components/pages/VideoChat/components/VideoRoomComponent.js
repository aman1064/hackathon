...
import {OPENVIDU_SERVER_SECRET, OPENVIDU_SERVER_URL} from "../config";
...
class VideoRoomComponent extends Component {
    ...
    startRecording = () => {
        const data = {outputMode: "COMPOSED", recordingLayout: "BEST_FIT", session: this.state.mySessionId}
        services
            ...
            this.setState({recordingObj: res.data})
        })
    }

    stopRecording = () => {
        const {recordingObj} = this.state;
        services
            .post(OPENVIDU_SERVER_URL + '/api/recordings/stop/' + recordingObj.id, {}, {
                headers: {
                    Authorization: 'Basic ' + btoa('OPENVIDUAPP:' + OPENVIDU_SERVER_SECRET),
                    'Content-Type': 'application/json',
                },
    ...
    kickOutUser = async connectionId => {
        const url = `${OPENVIDU_SERVER_URL}/api/sessions/${this.state.mySessionId}/connection/${connectionId}`;
        try {
    ...
    sendMessageToUser = async (connectionId, message) => {
        const url = `${OPENVIDU_SERVER_URL}/api/signal`;
        const data = {
            ...
            <div className="container" id="container">
                ...
                {/*<div id="layout" className="bounds">
                    <div>
                        ...
                        <Recordings serverUrl={OPENVIDU_SERVER_URL}
